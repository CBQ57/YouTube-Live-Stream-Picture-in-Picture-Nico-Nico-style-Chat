...
| 設定可能 | ポップアップから速度、文字サイズ、スタイル（色・太字・斜体・縁取り）、不透明度などを詳細に調整可能 |
| YouTube UI統合 | プレイヤー上の「NICO」「PIP」トグルボタンや、UI要素の非表示設定によるカスタマイズが可能 |
...
|---|---|---|
| スピード | 2 – 20 px/フレーム | 8 |
| 文字サイズ | 14 – 72 px | 26 px |
| 文字スタイル | 色 / 太字(B) / 斜体(I) / 縁取り(S) | 縁取り(S)のみオン |
| 不透明度 | 10 – 100 % | 90 % |
| 最大表示数 | 5 – 80 | 40 |
| ユーザー名を表示 | オン/オフ | オン |
| スーパーチャットを表示 | オン/オフ | オン |
| メンバーシップを表示 | オン/オフ | オン |
| NICOボタンを非表示 | オン/オフ | オフ |
| PIPボタンを非表示 | オン/オフ | オフ |
| PiP内チャットを非表示 | オン/オフ | オフ |
